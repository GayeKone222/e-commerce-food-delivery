...
import 'package:e_commerce/features/domain/entities/order_entity.dart';
import 'package:flutter/material.dart';
import 'package:webview_flutter/webview_flutter.dart';


//must add in the info.plist :
//<key>NSAppTransportSecurity</key>
	// <dict>
	// 	<key>NSAllowsarbritraryLoads</key>
	// 	<true/>
	// </dict>
...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  void initState() {
    super.initState();
    selectedUrl = '${ApiConstant.baseUrl}/payment-mobile?customer_id=${widget.orderModel.userId}&order_id=${widget.orderModel.id}';
  ...
  void _redirect(String url) {
    print("redirect");
    if(_canRedirect) {
      bool _isSuccess = url.contains('success') && url.contains(ApiConstant.baseUrl);
      bool _isFailed = url.contains('fail') && url.contains(ApiConstant.baseUrl);
      bool _isCancel = url.contains('cancel') && url.contains(ApiConstant.baseUrl);
